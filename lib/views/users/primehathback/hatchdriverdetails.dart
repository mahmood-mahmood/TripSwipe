...
import 'package:tripswipe/views//users/primehathback/hatchbackdriverconform.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:latlong2/latlong.dart';

class HatchbackDriv extends StatefulWidget {
  const HatchbackDriv({Key? key}) : super(key: key);

  @override
  State<HatchbackDriv> createState() => _HatchbackDrivState();
}

class _HatchbackDrivState extends State<HatchbackDriv> {
  @override
              ...
              children: [
                Expanded(
                  child: Consumer<Controller>(
                      builder: (context, carTypeController, _) {
                    return FutureBuilder(
                        future:
                            carTypeController.fetchCarsByCategory('cars','Hatchback'),
                        builder: (context, snapshot) {
                          return snapshot.connectionState ==
                              ...
                              : ListView.builder(
                                  itemCount: carTypeController.carsList.length,
