...
import 'package:tripswipe/views/users/primesedan/primesedanconform.dart';
              ...
              children: [
                Expanded(
                  child: Consumer<Controller>(
                      builder: (context, sedanController, _) {
                    return FutureBuilder(
                        future: sedanController.fetchCarsByCategory('cars','Sedan'),
                        builder: (context, snapshot) {
                          return snapshot.connectionState ==
                              ...
                              : ListView.builder(
                                  itemCount: sedanController.carsList.length,
